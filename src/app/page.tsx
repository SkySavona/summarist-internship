      ...
      <nav className="h-20 w-full">
        <div className="flex justify-between items-center max-w-[1070px] w-full h-full mx-auto px-6">
          ...
          <ul className="flex gap-6">
            <li className="cursor-pointer text-[#032b41] hover:text-[#2bd97c] transition-colors duration-100">
              Login
            </li>
        ...
        <div className="max-w-[1070px] w-full mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center">
            <div className="text-center md:text-left md:w-1/2">
              ...
              <button className="bg-[#2bd97c] text-[#032b41] w-full max-w-[300px] h-10 rounded text-base transition-colors duration-200 hover:bg-[#20ba68] flex items-center justify-center">
                Login
              </button>
            </div>
        ...
        <div className="max-w-[1070px] w-full mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-20">
            <div className="flex flex-col justify-center md:w-1/2">
              <h3 className="text-3xl font-medium text-[#6b757b] mb-4">
              ...
              <h3 className="text-3xl font-medium text-[#2bd97c] mb-4">
          ...
          <div className="max-w-[600px] mx-auto">
            ...
            <div className="bg-[#fff3d7] p-4 rounded mb-8">
              ...
              This app is a great way to get the main takeaways from a book without having to read the entire thing.{" "}
                <b>The summaries are well-written and informative.</b> Definitely worth downloading. </p>
            </div>
            <div className="bg-[#fff3d7] p-4 rounded mb-8">
              <div className="flex justify-between items-center mb-2">
              ...
              <p className="text-[#394547] leading-relaxed">
                ...
                <b>loves reading but doesn't have the time</b> to read every book in full, this app is for you! The summaries are thorough and provide a great overview of the book's content.
              </p>
            </div>
        ...
        <div className="max-w-[1070px] w-full mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-[#d7e9ff] flex flex-col items-center text-center p-6 rounded-xl">
              ...
              <div className="text-4xl font-bold text-[#032b41] mb-4">97%</div>
              <div className="text-lg text-[#394547] font-light">
